...
void Contrainte_Difference (int var1, int var2, std::vector<Variable*> &globalVars, std::vector<Contrainte*> &globalContraintes);  /* fonction permettant la création d'une nouvelle contrainte binaire de différence entre les variables var1 et var2*/
void Contrainte_Somme (int portee[], int arite, int val, std::vector<Variable*> &globalVars, std::vector<Contrainte*> &globalContraintes);  /* fonction permettant la création d'une nouvelle contrainte n-aire de somme portant sur les variables contenant
